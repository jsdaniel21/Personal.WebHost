(function () {
    ...
    var ws = {
        ...
        fillTipoModalidadCbo: function (target, codTipoEmpleado, callback) {
            $.ajax({
                type: 'GET',
                url: '/Employees/listTypeModality',
                data: { codTipoEmpleado: codTipoEmpleado },
                contentType: 'application/json; charset=utf-8',
                dataType: 'json',//tipo de dato que retornar el servidor
                success: function (e) {
                    callback(target, e)
                }
    ...
    var ctrl = {
        ...
        s_cboTipoEmpleado: $('#I_COD_TIPO_EMPLEADO'),
        s_cboTipoModalidad: $('#I_COD_TIPO_MODALIDAD')
    }
    ...
    var tags = function () {
        ...
        this.setEventsTags = function () {
            ...
            ctrl.s_cboTipoEmpleado.change(that.select.changeItem);
        }
            ...
            load: function () {
                ...
                switch ($(this).attr('id')) {
                    ...
                    case 'C_COD_PROVINCIA':
                        ...
                        break;
                    case 'I_COD_TIPO_EMPLEADO':
                        ws.fillTipoModalidadCbo(ctrl.s_cboTipoModalidad, $(this).val(), that.fillSelect)
                        break;
                    default:
                }
            }
