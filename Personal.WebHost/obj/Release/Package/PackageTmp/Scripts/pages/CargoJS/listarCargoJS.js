            ...
            this.handle = {
                ...
                handleCreateCharge: function () {
                    this.ctrl.crear.click(function () {
                        ...
                        pedidos.popup.executePopupNoBor("agrege un nuevo cargo para el personal", 'asignar un cargo'
                            , '/Cargo/_crear', '500', '410', function () {
                ...
                handleSubmitAnular: function () {
                    this.ctrl.SubmitObservation.click(function () {
                        var select = this.ctrl.gridCargos.find('tbody > tr[class="active-row-select"]');
                        ws.anularChargeForPeople(select.find('td:first-child > span').html(), this.ctrl.observacion.val(), function (e) {
                            if (e.length > 0) {
